document.addEventListener('DOMContentLoaded', () => {
    ...
    btnConnect.addEventListener('click', () => {
        apiBaseUrl = apiBaseInput.value || 'http://localhost:5000';
        loadParts();
    });
    ...
    // Adicione este objeto no início do arquivo montagem.js (após as declarações de variáveis)
     const categoryIcons = {
...
// Modifique o evento do btnSave:
btnSave.addEventListener('click', () => {
  saveBuildToLocalStorage();
  // Opcional: ainda pode manter o salvamento na API se quiser
});
});
